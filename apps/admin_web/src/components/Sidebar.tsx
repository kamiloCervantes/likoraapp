  ...
  return (
    <aside className="w-64 min-w-[16rem] bg-[#181440] flex flex-col justify-between flex-shrink-0 min-h-screen text-white select-none shadow-2xl border-r border-indigo-950">
      <div>
        ...
        <div className="p-6 flex items-center gap-3 border-b border-white/5">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-[#928cb8] mt-1 font-medium">
              Backoffice Suite
            </span>
          </div>
        </div>
        ...
        <div className="px-4 py-4 space-y-6">
          {/* Section: General */}
          <div>
            <div className="px-3 pb-2 text-[11px] font-semibold text-[#928cb8] uppercase tracking-wider">
              General
            </div>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ? 'bg-[#3b3388] text-white shadow-md font-semibold ring-1 ring-white/10'
                        : 'text-[#a5a0cb] hover:text-white hover:bg-white/5'
                    )}
                  >
      ...
      <div className="p-4 m-4 bg-[#120f33] border border-white/5 rounded-2xl flex items-center gap-3">
        <div className="w-8 h-8 rounded-full bg-[#3b3388] text-white font-bold text-xs flex items-center justify-center ring-1 ring-white/20">
          LA
        </div>
