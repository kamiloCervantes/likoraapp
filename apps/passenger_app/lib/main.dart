...
import 'features/kyc/kyc_form_screen.dart';
    ...
    return AppStateProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          AppRoutes.kycIntro: (context) => const KycIntroScreen(),
          AppRoutes.kycForm: (context) => const KycFormScreen(),
          AppRoutes.kycStatus: (context) => const KycStatusScreen(),
        },
        onGenerateRoute: (settings) {
          if (settings.name == AppRoutes.kycPhotos) {
            final args = settings.arguments as Map<String, dynamic>;
            return MaterialPageRoute(
              builder: (context) => KycPhotoUploadScreen(formData: args),
            );
          } else if (settings.name == AppRoutes.categoryDetail) {
            final args = settings.arguments as Map<String, dynamic>;
